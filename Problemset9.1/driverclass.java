...
public class driverclass
{
   public static void main(String[] args){
       ...
       System.out.println(shapes[i].displayInfo());
       System.out.println("The perimeter is "+shapes[i].calculatePerimeter());
       System.out.println("The area is "+shapes[i].calculateArea());
    }
   }
}
